/*
  ...
  1. Security Updates
    - Drop existing restrictive INSERT policy for chat_messages
    - Create new policy that allows users to send messages in rooms they have access to
    - Ensure admin/moderator access to all rooms
    - Support branch-based room access matching

  2. Changes
    - Remove overly complex INSERT policy
    - Add simplified policy based on room membership and branch matching
...
-- Create a new INSERT policy that allows users to send messages in rooms they can access
