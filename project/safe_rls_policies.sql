-- Safe RLS Policies - Only for existing columns
-- Bu dosya sadece mevcut sütunları kullanarak güvenli RLS politikaları oluşturur
...
-- 2. POSTS TABLE - Gönderiler (eğer user_id sütunu varsa)
-- ========================================================

-- Check if posts table exists and has user_id column
DO $$
BEGIN
  IF EXISTS (
...
-- 3. COMMENTS TABLE - Yorumlar (eğer user_id sütunu varsa)
-- ========================================================
...
-- 4. LIKES TABLE - Beğeniler (eğer user_id sütunu varsa)
-- ======================================================
...
-- 5. JOB_LISTINGS TABLE - İş İlanları (eğer user_id sütunu varsa)
-- ================================================================
...
-- 6. CHAT_MESSAGES TABLE - Chat Mesajları (eğer user_id sütunu varsa)
-- ====================================================================
...
-- 7. PRIVATE_MESSAGES TABLE - Özel Mesajlar (eğer sender_id ve receiver_id sütunları varsa)
-- =========================================================================================
...
-- 8. NOTIFICATIONS TABLE - Bildirimler (eğer user_id sütunu varsa)
-- ================================================================
...
-- 9. FRIEND_REQUESTS TABLE - Arkadaşlık İstekleri (eğer sender_id ve receiver_id sütunları varsa)
-- ==============================================================================================
